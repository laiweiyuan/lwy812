    ...
    <div class="admin-login">
        <div class="login-container">
            ...
            <div class="login-right">
                ...
                >
                    <p style="margin-left: 4px; text-align: left;font-size: 28px;margin-bottom: 30px">智慧校园</p>
...
<style lang="scss" scoped>
    ...
    .admin-login {
        ...
        padding: 0 12rem;
        overflow: hidden;
        background-image: url("../assets/791710ce08ec4af025d84e2db0ca905d778d1e698497-vx5VvH_fw658 copy.webp");
