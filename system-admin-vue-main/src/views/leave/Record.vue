<template>
    <div class="main-class">
        <el-form v-permission="['ROLE_teacher']" :model="queryParams" ref="queryForm" :inline="true" label-width="88px">
        ...
        <el-dialog title="审核请假记录" :visible.sync="examineOpen" width="100%" append-to-body>
