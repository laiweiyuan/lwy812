...
CREATE TABLE `access_register`  (
  ...
  `type` int(1) NULL DEFAULT NULL COMMENT '出入类型（1：出校 0：入校）',
  `card` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '身份证号',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
  `dept` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '部门',
  `create_by` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `is_delete` int(1) NULL DEFAULT 0 COMMENT '逻辑删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '出入登记表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `access_return`  (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '自增id',
  `name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '姓名',
  `phone` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '手机号码',
  `card` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '身份证号码',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
  `dept` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '部门',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `name_index`(`name`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '未归用户表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `good_info`  (
  ...
  `name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '物资名称',
  `img` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '图片链接',
  `size` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '物资规格',
  `unit` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '物资单位',
  `create_by` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `remark` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
  `total` int(11) NULL DEFAULT NULL COMMENT '库存',
  `status` int(1) NULL DEFAULT 1 COMMENT '是否启用',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `is_delete` int(1) NULL DEFAULT 0 COMMENT '逻辑删除',
...
CREATE TABLE `good_stock`  (
  ...
  `accept` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '去向',
  `create_by` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '操作人',
  `good_num` int(11) NULL DEFAULT NULL COMMENT '物资数量',
  `good_size` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '物资规格',
  `good_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '物资名',
  `people_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '联系人',
  `people_phone` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '联系人电话',
  `operate_type` int(1) NULL DEFAULT 1 COMMENT '操作类型',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `is_delete` int(1) NULL DEFAULT 0 COMMENT '逻辑删除',
  `version` int(11) NULL DEFAULT 1 COMMENT '乐观锁',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '物资出入库表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `good_type`  (
  ...
  `type` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '物资类型',
  ...
  `is_delete` int(1) NULL DEFAULT 0 COMMENT '逻辑删除',
  `version` int(11) NULL DEFAULT 1 COMMENT '乐观锁',
  `remark` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '物资类型表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `health_clock`  (
  ...
  `username` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '姓名',
  `health_type` int(1) NULL DEFAULT NULL COMMENT '健康状况',
  `temperature` float(6, 1) NULL DEFAULT NULL COMMENT '温度',
  `middle_high` int(1) NULL DEFAULT NULL COMMENT '中高风险',
  `diagnosis` int(1) NULL DEFAULT NULL COMMENT '确诊',
  `return_info` int(1) NULL DEFAULT NULL COMMENT '境外返回',
  `address` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '地址',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `dept_id` int(11) NULL DEFAULT NULL COMMENT '部门id',
  `is_delete` int(1) NULL DEFAULT 0 COMMENT '逻辑删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '打卡健康表' ROW_FORMAT = Dynamic;
...
INSERT INTO `health_clock` VALUES (7, 'admin', 2, 38.2, 1, 1, 1, '北京市-市辖区-朝阳区', '2022-08-24 17:13:29', '2022-08-24 17:13:29', 103, 0);
...
CREATE TABLE `health_report`  (
  ...
  `img3` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '核酸报告',
  `img2` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '行程码',
  `img1` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '健康码',
  `type` int(1) NULL DEFAULT NULL COMMENT '返校情况',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '二码一报告表' ROW_FORMAT = Dynamic;
...
INSERT INTO `health_report` VALUES (7, 'student', 103, '17730312784', 'http://localhost:8081/img/2022/8/f75e1278e26f426aad4ff9c80987cbc0.png', 'http://localhost:8081/img/2022/8/7d86ed13f820445fa8bc004df6472e2f.png', 'http://localhost:8081/img/2022/8/66aaa8e6da21466ba9c5f47abb235591.png', 1, '2022-08-24 16:15:48', '2022-08-24 16:15:48');
...
CREATE TABLE `leave_apply`  (
  ...
  `leave_type` int(1) NULL DEFAULT NULL COMMENT '请假类型（1：事假 2：病假）',
  `status` int(1) NULL DEFAULT NULL COMMENT '状态（0：撤销 1：待审核 2：审核通过 3：审核不通过）',
  `student_type` int(1) NULL DEFAULT NULL COMMENT '学生类型（1：本科生 2：研究生 3：博士生）',
  `nickname` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '学生姓名',
  `time` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '请假时间区间',
  `day` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '请假天数',
  `address` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '目的地',
  `traffic` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '交通工具',
  `clazz` int(1) NULL DEFAULT NULL COMMENT '是否有课程（1：没有 0：有）',
  `dormitory` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '宿舍',
  `phone_number` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '手机号码',
  `exam` int(1) NULL DEFAULT NULL COMMENT '考试（1：没有 0：有）',
  `opinion` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '审核意见',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `is_delete` int(1) NULL DEFAULT 0 COMMENT '逻辑删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '请假审批表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_dept`  (
  ...
  `status` int(1) NULL DEFAULT 1 COMMENT '部门状态（1正常 0停用）',
...
CREATE TABLE `sys_login_info`  (
  ...
  `login_location` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '登录地点',
  `browser` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '浏览器类型',
  `os` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '操作系统',
  `status` int(1) NULL DEFAULT 1 COMMENT '登录状态（0成功 1失败）',
  `msg` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '提示消息',
...
INSERT INTO `sys_login_info` VALUES (171, 'admin', '127.0.0.1', ' 本机地址', 'Chrome 10', 'Windows 10', 0, '用户名或密码错误', '2022-08-21 23:06:41');
INSERT INTO `sys_login_info` VALUES (172, 'admin', '127.0.0.1', ' 本机地址', 'Chrome 10', 'Windows 10', 0, '用户名或密码错误', '2022-08-21 23:07:11');
INSERT INTO `sys_login_info` VALUES (173, 'admin', '127.0.0.1', ' 本机地址', 'Chrome 10', 'Windows 10', 0, '用户名或密码错误', '2022-08-21 23:11:36');
INSERT INTO `sys_login_info` VALUES (174, 'admin', '127.0.0.1', ' 本机地址', 'Chrome 10', 'Windows 10', 1, '登陆成功', '2022-08-21 23:15:58');
INSERT INTO `sys_login_info` VALUES (175, 'admin', '127.0.0.1', ' 本机地址', 'Chrome 10', 'Windows 10', 1, '登陆成功', '2022-08-22 17:40:41');
INSERT INTO `sys_login_info` VALUES (176, 'student', '127.0.0.1', ' 本机地址', 'Chrome 10', 'Windows 10', 1, '登陆成功', '2022-08-24 11:09:39');
INSERT INTO `sys_login_info` VALUES (177, 'admin', '127.0.0.1', ' 本机地址', 'Chrome 10', 'Windows 10', 1, '登陆成功', '2022-08-24 15:24:03');
INSERT INTO `sys_login_info` VALUES (178, 'student', '127.0.0.1', ' 本机地址', 'Chrome 10', 'Windows 10', 1, '登陆成功', '2022-08-24 15:24:27');
INSERT INTO `sys_login_info` VALUES (179, 'admin', '127.0.0.1', ' 本机地址', 'Chrome 10', 'Windows 10', 1, '登陆成功', '2022-08-24 15:26:45');
INSERT INTO `sys_login_info` VALUES (180, 'student', '127.0.0.1', ' 本机地址', 'Chrome 10', 'Windows 10', 1, '登陆成功', '2022-08-24 16:14:46');
INSERT INTO `sys_login_info` VALUES (181, 'admin', '127.0.0.1', ' 本机地址', 'Chrome 10', 'Windows 10', 0, '用户名或密码错误', '2022-08-24 17:02:52');
INSERT INTO `sys_login_info` VALUES (182, 'admin', '127.0.0.1', ' 本机地址', 'Chrome 10', 'Windows 10', 0, '用户名或密码错误', '2022-08-24 17:03:09');
INSERT INTO `sys_login_info` VALUES (183, 'admin', '127.0.0.1', ' 本机地址', 'Chrome 10', 'Windows 10', 1, '登陆成功', '2022-08-24 17:04:00');
INSERT INTO `sys_login_info` VALUES (184, 'student', '127.0.0.1', ' 本机地址', 'Chrome 10', 'Windows 10', 1, '登陆成功', '2022-08-24 17:17:06');
INSERT INTO `sys_login_info` VALUES (185, 'admin', '127.0.0.1', ' 本机地址', 'Chrome 10', 'Windows 10', 0, '用户名或密码错误', '2022-08-25 11:34:50');
INSERT INTO `sys_login_info` VALUES (186, 'admin', '127.0.0.1', ' 本机地址', 'Chrome 10', 'Windows 10', 0, '用户名或密码错误', '2022-08-25 11:35:05');
INSERT INTO `sys_login_info` VALUES (187, 'admin', '127.0.0.1', ' 本机地址', 'Chrome 10', 'Windows 10', 1, '登陆成功', '2022-08-25 11:35:18');
INSERT INTO `sys_login_info` VALUES (188, 'admin', '127.0.0.1', ' 本机地址', 'Chrome 10', 'Windows 10', 1, '登陆成功', '2022-08-25 11:57:40');
INSERT INTO `sys_login_info` VALUES (189, 'admin', '127.0.0.1', ' 本机地址', 'Chrome 10', 'Windows 10', 1, '登陆成功', '2022-08-25 13:39:05');
INSERT INTO `sys_login_info` VALUES (190, 'student', '127.0.0.1', ' 本机地址', 'Chrome 10', 'Windows 10', 1, '登陆成功', '2022-08-25 13:42:47');
...
INSERT INTO `sys_operate_log` VALUES (121, '二码一报告', '添加报告', 'com.fanchen.controller.HealthReportController.save()', 'POST', '/health/report', '127.0.0.1', ' 本机地址', '{} {\"authenticated\":true,\"authorities\":[{},{},{},{},{},{},{},{},{},{},{},{},{}],\"principal\":\"student\"}', 'student', '{\"msg\":\"操作成功\",\"code\":200,\"data\":\"上报成功\"}', 1, '', '2022-08-24 11:15:54');
INSERT INTO `sys_operate_log` VALUES (122, '二码一报告', '添加报告', 'com.fanchen.controller.HealthReportController.save()', 'POST', '/health/report', '127.0.0.1', ' 本机地址', '{} {\"authenticated\":true,\"authorities\":[{},{},{},{},{},{},{},{},{},{},{},{},{}],\"principal\":\"student\"}', 'student', '{\"msg\":\"操作成功\",\"code\":200,\"data\":\"上报成功\"}', 1, '', '2022-08-24 16:15:48');
INSERT INTO `sys_operate_log` VALUES (123, '健康打卡', '添加打卡', 'com.fanchen.controller.HealthClockController.save()', 'POST', '/health/clock', '127.0.0.1', ' 本机地址', '{\"address\":\"北京市-市辖区-朝阳区\",\"deptId\":103,\"diagnosis\":1,\"healthType\":2,\"updateTime\":1661332409398,\"middleHigh\":1,\"returnInfo\":1,\"createTime\":1661332409398,\"temperature\":38.2,\"id\":7,\"username\":\"admin\"}', 'admin', '{\"msg\":\"操作成功\",\"code\":200,\"data\":\"打卡成功\"}', 1, '', '2022-08-24 17:13:30');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'admin', '$2a$10$ImwV/lNJmRAtKYEkDFqLQu4pa3FovOQx7XzQc0JVFU5Ee3MM17R16', '超级管理员', 'http://localhost:8081/img/2021/12/97b195d7383b47a08cbc6b88aaed3b2a.jpg', '17730312784', '江苏南京', 103, '2021-01-12 22:13:53', '2021-12-18 20:05:00', '超级管理员', 1, 0, 53);
INSERT INTO `sys_user` VALUES (2, 'student', '$2a$10$ImwV/lNJmRAtKYEkDFqLQu4pa3FovOQx7XzQc0JVFU5Ee3MM17R16', '学生用户', 'http://localhost:8081/img/2021/12/400bba2995ec46fc97249cece09f9ca4.jpg', '17730312784', '常州', 103, '2021-12-13 14:07:44', '2021-12-17 19:23:17', '学生用户', 1, 0, 4);
INSERT INTO `sys_user` VALUES (3, 'service', '$2a$10$ImwV/lNJmRAtKYEkDFqLQu4pa3FovOQx7XzQc0JVFU5Ee3MM17R16', '后勤用户', 'http://localhost:8081/img/2021/12/59b880040d6443b28956519118c2d507.jpg', '18855331293', '芜湖', 104, '2021-12-13 14:11:13', '2021-12-17 19:23:06', '后勤用户', 1, 0, 6);
INSERT INTO `sys_user` VALUES (4, 'teacher', '$2a$10$ImwV/lNJmRAtKYEkDFqLQu4pa3FovOQx7XzQc0JVFU5Ee3MM17R16', '老师用户', 'http://localhost:8081/img/2021/12/400bba2995ec46fc97249cece09f9ca4.jpg', '13966346765', '常州', 200, '2021-12-16 12:27:41', '2021-12-16 18:03:52', '老师用户', 1, 0, 3);
